...
class DataTransform(object):
    ...
    def __call__(self, data_dict):
        ...
        for task in data_dict:
            ...
            if task in ['im', 'noise']:
                data_dict[task] = transforms_f.resize(data_dict[task], resized_size, transforms_f.InterpolationMode.BILINEAR)
            elif task in ['normal', 'depth', 'seg', 'part_seg', 'disp']:
                data_dict[task] = transforms_f.resize(data_dict[task], resized_size, transforms_f.InterpolationMode.NEAREST)
